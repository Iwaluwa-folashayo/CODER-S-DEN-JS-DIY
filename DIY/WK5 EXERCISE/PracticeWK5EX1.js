...
let items = [24, 'lemon', true, undefined, 'age', 'plant', 76, 'beans' ]
...
console.log(Companies.concat(sentence))

// 13.Check if a certain company exists in the itCompanies array. If it exist return the company else return a company is not found
// console.log(itCompanies.includes('Google'))

if(itCompanies.includes('Google') == true ){
    console.log('Google is part of IT companies')
}
else{
