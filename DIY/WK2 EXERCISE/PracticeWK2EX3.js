...
let stringg = 'Love is the best thing in this world. Some found their love and some are still looking for their love.'

let pattern = /love/gi
console.log(stringg.match(pattern))


// Use match() to count the number of all because in the following sentence:'You cannot end a sentence with because because because is a conjunction'
let sentencee = 'You cannot end a sentence with because because because is a conjunction'
let patternOne = /because/gi
console.log(sentencee.match(patternOne))
